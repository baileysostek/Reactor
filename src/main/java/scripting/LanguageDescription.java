...
public class LanguageDescription {
    ...
    public LanguageDescription(){
        ...
        //Define pemdas Or how to weigh each possible action math could preform.
        ...
        registerTokenCodePair(EnumTokenType.RETURN               , "return");
        ...
        registerTokenCodePair(EnumTokenType.NOT_EQUAL            , "!=");
...
//                System.out.println("-------------------------"+scopeSize+"-------------------------");
        ...
        addPattern(new EnumTokenType[]{EnumTokenType.VARIABLE_DECLARATION, EnumTokenType.VARIABLE_NAME, EnumTokenType.SET_EQUAL, EnumTokenType.WILDCARD}, new Callback() {
            ...
            public Object callback(Object... objects) {
                ...
                def.addVar(pattern[1].code, ScriptingEngine.getInstance().resolveToken(def, def.scope, line));
...
//                    }
                    ...
                    if(script.tokensInFile.get(offset-1).getToken().equals(EnumTokenType.VARIABLE_DECLARATION)){
                        ...
                        return  1;
                    }else if(script.tokensInFile.get(offset-2).getToken().equals(EnumTokenType.CLASS_REFRENCE)){
                        if(ScriptingEngine.getInstance().registeredClasses.containsKey(unknown.getCode())){
                            ScriptingEngine.getInstance().registeredClasses.get(unknown.getCode());
                        }
                        return  1;
                    }else {
