...
//-----------------------------------------------------------------------------
// Purpose: allow dxabstract to read back the capabilities of the selected graphics.renderer
//-----------------------------------------------------------------------------

void	CGameEngineGL::GetRendererInfo( GLMRendererInfoFields *rendInfoOut )
{
	// hardwired to graphics.renderer 0 which is fine on any single monitor system
	if (rendInfoOut)
	{
